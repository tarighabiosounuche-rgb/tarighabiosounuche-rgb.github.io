...
**Title**: [Sale Performance Analysis Dashboard] (https://github.com/tarighabiosounuche-rgb/tarighabiosounuche-rgb.github.io/blob/main/Cookie.xlsx)

**Tools Used**: (Microsoft EXCEL, Slicers, Pivot table,Pivot chat, timelines, )
